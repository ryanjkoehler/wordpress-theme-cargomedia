...
<article id="post-<?php the_ID(); ?>" <?php post_class( $feature_class ); ?>>
	...
	<footer class="entry-meta">
		<?php
			...
			$tag_list = get_the_tag_list( '', __( ', ', 'cargomedia' ) );
			if ( '' != $tag_list ) {
				$utility_text = __( 'This entry was posted in %1$s and tagged %2$s. Bookmark the <a href="%3$s" title="Permalink to %4$s" rel="bookmark">permalink</a>.', 'cargomedia' );
			} else {
				$utility_text = __( 'This entry was posted in %1$s. Bookmark the <a href="%3$s" title="Permalink to %4$s" rel="bookmark">permalink</a>.', 'cargomedia' );
			}
			printf(
				$utility_text,
				/* translators: used between list items, there is a space after the comma */
				get_the_category_list( __( ', ', 'cargomedia' ) ),
				$tag_list,
